...
export const SERVICES: Service[] = [
  {
    ...
    steps: [
      ...
      "We run /seo audit — 25 sub-skills fire simultaneously",
  ...
  },
  {
    ...
    steps: [
      "Run /seo geo and /geo audit on your site",
  ...
  },
  {
    ...
    steps: [
      "Run /seo content across your top 20 pages",
  ...
  },
  {
    ...
    steps: [
      "Run /seo local on your business website",
  ...
  },
  {
    ...
    steps: [
      "Run /geo crawlers on your domain",
  ...
  },
  {
    ...
    steps: [
      "Run /geo brands to scan brand mentions across major AI-cited platforms",
  ...
  },
  {
    ...
    steps: [
      "Run /seo backlinks on your domain",
  ...
  },
  {
    ...
    steps: [
      "Run /seo cluster [your keyword] to build a SERP-based cluster",
  ...
  },
  {
    ...
    steps: [
      "Run /seo ecommerce on your storefront",
  ...
  },
  {
    ...
    steps: [
      "Run /seo hreflang across all language and country variants",
  ...
  },
  {
    ...
    steps: [
      "Run /seo drift baseline on Day 1 to capture current site state in SQLite",
      "Weekly /seo drift compare runs detect any changes or regressions",
      "Monthly /geo compare tracks GEO score and AI citation frequency over time",
  ...
  },
  {
    ...
    steps: [
      "Run /seo competitor-pages — provide your URL and up to 3 competitor URLs",
  ...
  },
  {
    ...
    steps: [
      "Run /seo sitemap [your-sitemap-url] to analyse current state",
  ...
  },
  {
    ...
    steps: [
      "Run /seo images across your top landing pages",
  ...
  },
  {
    ...
    steps: [
      "Run /seo programmatic to analyse your current template pages",
  ...
  },
  {
    ...
    steps: [
      "Run /geo citability on your key service and content pages",
  ...
  },
  {
    ...
    steps: [
      "Run /geo platforms on your domain",
  ...
  },
  {
    ...
    steps: [
      "Run /geo llmstxt to analyse any existing llms.txt on your domain",
  ...
  },
  {
    ...
    steps: [
      ...
      "Run /geo report-pdf and /seo google report to generate PDF outputs",
  ...
  },
  {
    ...
    group: "Monitoring, Strategy & Reporting",
    tag: "Retainer",
    command: "Monthly retainer",
    question: "How do we keep your SEO score climbing every month on a retainer basis?",
    value:
      "We run a monthly cycle of audit, fix and report so your score climbs every month and you always know exactly what changed and why.",
    steps: [
      "Month 1: Full baseline audit, set score targets, fix critical issues",
      "Each month: re-run /seo audit + /geo audit and compare to baseline",
      "Implement the top 3–5 priority fixes — technical, content, and schema updates",
      "Update llms.txt, robots.txt, and schema for any Google updates that month",
      "Deliver monthly progress report: score trend, ranking movement, work log",
    ],
  },
  {
    n: 24,
    ...
    steps: [
      ...
      "Run /seo plan [type] to generate a type-specific strategic plan",
